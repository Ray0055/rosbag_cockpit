...
class RosbagPlayer:
    ...
    def play_bag(self, bag_path: str, topics: Optional[List[str]] = None, 
                 rate: float = 1.0, start: float = 0.0, duration: Optional[float] = None,
                 loop: bool = False, clock: bool = True) -> subprocess.Popen:
        """
